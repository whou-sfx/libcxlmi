...
/*
 * mbcci-sfx: Command Effects Log (CEL) parser.
 *
...
/*
 * Opcodes from Generic-Component-Commands.md, Memory-Device-Commands.md,
 * and FM-API.md (command_set << 8 | command).
 */
