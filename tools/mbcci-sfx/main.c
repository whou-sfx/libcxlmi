...
static const struct subcmd subcmds[] = {
	...
	{ "dcd-get-config",            cmd_get_dc_config,
	  "Get DC Configuration (4800h) [--region-cnt <n>] [--start-region-id <n>]" },
	{ "dcd-get-extent-list",       cmd_get_dc_extent_list,
	  "Get DC Extent List (4801h) [--extent-cnt <n>] [--start-extent-idx <n>]" },
	{ "dcd-add-response",          cmd_add_dc_response,
	  "Add DC Response (4802h) [--flags <n>] [--extent <dpa>:<len>] ..." },
	{ "dcd-release",               cmd_release_dc,
	  "Release Dynamic Capacity (4803h) [--flags <n>] [--extent <dpa>:<len>] ..." },
